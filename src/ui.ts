...
const I18N = {
  en: {
    ...
    how_it_works: 'How it works', feedback: 'Feedback', fb_label: 'What should we improve?', fb_email_label: 'Your email (optional, if you want a reply)', fb_send: 'Send', fb_thanks: 'Thanks — your feedback reached us.', fb_fail: 'Could not send feedback', welcome_profile: 'Welcome aboard! Set up your musician profile — it is what lets you apply to gigs and jams.',
  ...
  fr: {
    ...
    how_it_works: 'Comment \u00e7a marche', feedback: 'Vos retours', fb_label: 'Que pouvons-nous améliorer ?', fb_email_label: 'Votre e-mail (facultatif, pour une réponse)', fb_send: 'Envoyer', fb_thanks: 'Merci — votre retour nous est bien parvenu.', fb_fail: 'Impossible d’envoyer le retour', welcome_profile: 'Bienvenue ! Cr\u00e9ez votre profil musicien — c\u2019est lui qui vous permet de postuler aux concerts et aux jams.',
  ...
  it: {
    ...
    how_it_works: 'Come funziona', feedback: 'Feedback', fb_label: 'Cosa possiamo migliorare?', fb_email_label: 'La tua e-mail (facoltativa, per una risposta)', fb_send: 'Invia', fb_thanks: 'Grazie — il tuo feedback ci è arrivato.', fb_fail: 'Impossibile inviare il feedback', welcome_profile: 'Benvenuto/a! Crea il tuo profilo musicista — \u00e8 ci\u00f2 che ti permette di candidarti a concerti e jam.',
