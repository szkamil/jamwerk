...
<footer>
  ...
  <div class="inner">
    ...
    <span data-i18n="foot_made">Made for local musicians in Switzerland</span>
    <span class="spacer"></span>
...
const I18N = {
  en: {
    ...
    how_it_works: 'How it works', foot_made: 'Made for local musicians in Switzerland', welcome_profile: 'Welcome aboard! Set up your musician profile — it is what lets you apply to gigs and jams.',
  ...
  fr: {
    ...
    how_it_works: 'Comment \u00e7a marche', foot_made: 'Fait pour les musiciens locaux en Suisse', welcome_profile: 'Bienvenue ! Cr\u00e9ez votre profil musicien — c\u2019est lui qui vous permet de postuler aux concerts et aux jams.',
  ...
  de: {
    ...
    how_it_works: 'So funktioniert\u2019s', foot_made: 'Gemacht f\u00fcr lokale Musiker:innen in der Schweiz', welcome_profile: 'Willkommen! Richte dein Musikerprofil ein — damit kannst du dich auf Gigs und Jams bewerben.',
  ...
  it: {
    ...
    how_it_works: 'Come funziona', foot_made: 'Fatto per i musicisti locali in Svizzera', welcome_profile: 'Benvenuto/a! Crea il tuo profilo musicista — \u00e8 ci\u00f2 che ti permette di candidarti a concerti e jam.',
