...
const I18N = {
  en: {
    ...
    how_it_works: 'How it works', tagline: 'gigs · jams · bands', feedback: 'Feedback', fb_label: 'What should we improve?', fb_email_label: 'Your email (optional, if you want a reply)', fb_send: 'Send', fb_thanks: 'Thanks — your feedback reached us.', fb_fail: 'Could not send feedback', welcome_profile: 'Welcome aboard! Set up your musician profile — it is what lets you apply to gigs and jams.',
  ...
  fr: {
    ...
    how_it_works: 'Comment \u00e7a marche', tagline: 'concerts \u00b7 jams \u00b7 groupes', feedback: 'Vos retours', fb_label: 'Que pouvons-nous améliorer ?', fb_email_label: 'Votre e-mail (facultatif, pour une réponse)', fb_send: 'Envoyer', fb_thanks: 'Merci — votre retour nous est bien parvenu.', fb_fail: 'Impossible d’envoyer le retour', welcome_profile: 'Bienvenue ! Cr\u00e9ez votre profil musicien — c\u2019est lui qui vous permet de postuler aux concerts et aux jams.',
